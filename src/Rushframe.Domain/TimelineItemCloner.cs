...
public static class TimelineItemCloner
{
    ...
    public static TimelineItem Clone(TimelineItem source, MediaTime? timelineStart = null, bool preserveId = false)
    {
        ...
        var clone = new TimelineItem
        {
            ...
            VisualTransitionIn = source.VisualTransitionIn,
            VisualTransitionInDuration = source.VisualTransitionInDuration,
            VisualTransitionOut = source.VisualTransitionOut,
            VisualTransitionOutDuration = source.VisualTransitionOutDuration,
            Pan = source.Pan,
